defmodule MindfullWeb.UserAuthTest do
  use MindfullWeb.ConnCase, async: true

  alias Mindfull.Accounts
  alias MindfullWeb.UserAuth
  import Mindfull.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MindfullWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MindfullWeb.Endpoint.subscribe(live_socket_id)
